...
var Model = Class.extend({
    ...
    initialize: function(options, attributes) {
        ...
        attributes = utils.deepExtend({}, _.result(this, "defaults"), attributes);
    ...
    set: function(key, value, options) {
        ...
        newattributes = utils.deepExtend({}, this.attributes || {}, attrs);
        if (!options.silent) {
            diffs = jsondiffpatch.diff(this._prevAttributes || {}, newattributes);
        }
        this.attributes = newattributes;
        this._prevAttributes = utils.deepClone(this.attributes);
